#------------------------------
# Exercise 15.3.1.1 R4DS: Explore income distribution in forcats::gss_cat data.
#------------------------------
library("forcats")
library("tidyverse")
...
# it is probably better to have income intervals with equal width:
